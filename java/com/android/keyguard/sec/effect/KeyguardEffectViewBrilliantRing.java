...
public class KeyguardEffectViewBrilliantRing extends EffectView implements KeyguardEffectViewBase {
    ...
    private static final String LOCK_SOUND_PATH = "/system/media/audio/ui/ve_brilliantring_lock.ogg";
    ...
    /* renamed from: com.android.keyguard.sec.effect.KeyguardEffectViewBrilliantRing$1 */
    class C04801 implements IEffectListener {
        C04801() {
        }

        public void onReceive(int status, HashMap<?, ?> hashMap) {
            if (status == 0 && KeyguardEffectViewBrilliantRing.this.mHandler != null) {
                KeyguardEffectViewBrilliantRing.this.mMsg = KeyguardEffectViewBrilliantRing.this.mHandler.obtainMessage();
                KeyguardEffectViewBrilliantRing.this.mMsg.what = 0;
                KeyguardEffectViewBrilliantRing.this.mHandler.sendMessage(KeyguardEffectViewBrilliantRing.this.mMsg);
            }
        }
    }

    /* renamed from: com.android.keyguard.sec.effect.KeyguardEffectViewBrilliantRing$2 */
    ...
    /* renamed from: com.android.keyguard.sec.effect.KeyguardEffectViewBrilliantRing$3 */
    class C04823 implements OnLoadCompleteListener {
        C04823() {
        }
    ...
    /* renamed from: com.android.keyguard.sec.effect.KeyguardEffectViewBrilliantRing$4 */
    class C04834 implements Runnable {
        C04834() {
        }
    ...
    /* renamed from: com.android.keyguard.sec.effect.KeyguardEffectViewBrilliantRing$5 */
    class C04845 implements Runnable {
        C04845() {
        }
    ...
    public class EffectHandler extends Handler {
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    if (KeyguardEffectViewBrilliantRing.this.mImageView != null) {
                        Log.d(KeyguardEffectViewBrilliantRing.TAG, "removeView mImageView");
                        KeyguardEffectViewBrilliantRing.this.mImageView.setImageBitmap(null);
                        KeyguardEffectViewBrilliantRing.this.removeView(KeyguardEffectViewBrilliantRing.this.mImageView);
                        KeyguardEffectViewBrilliantRing.this.mImageView = null;
                        return;
                    }
                    return;
                default:
    ...
    public KeyguardEffectViewBrilliantRing(Context context, KeyguardWindowCallback callback) {
        super(context);
        init(context, callback, true, 0);
    }

    public KeyguardEffectViewBrilliantRing(Context context, KeyguardWindowCallback callback, boolean mWallpaperProcessSeparated, int displayId) {
        super(context);
    ...
    private void init(Context context, KeyguardWindowCallback callback, boolean mWallpaperProcessSeparated, int displayId) {
        ...
        this.callBackListener = new C04801();
    ...
    private void makeSound() {
        ...
        if (KeyguardUpdateMonitor.getInstance(this.mContext).hasBootCompleted() && this.mSoundPool == null) {
            ...
            this.mSoundPool.setOnLoadCompleteListener(new C04823());
        }
    }
    ...
    private void releaseSound() {
        this.releaseSoundRunnable = new C04834();
